<?php
if (!empty($_GET['firs_name']) && !empty($_GET['last_name']) && !empty($_GET['phone']) && !empty($_GET['age'])) {
    ...
    if (isset($_COOKIE['data'])) { // если кука установлена мы ее записываем в имя и возраст что бы не потерять значения когда выйдем с страницы
        ...
        echo 'Введите все данные в форму отправки';
    }
}
